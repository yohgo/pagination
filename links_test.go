...
var newLinksDataProvider = []struct {
	...
	},
	{
		...
		url:   "api.illuminate.effcomm.com/v1/users?page=3&limit=3&order_by=name&order=asc",
		count: 3,
		links: &pagination.Links{
			Next:     "api.illuminate.effcomm.com/v1/users?limit=3&order=asc&order_by=name&page=4",
			Previous: "api.illuminate.effcomm.com/v1/users?limit=3&order=asc&order_by=name&page=2",
			Self:     "api.illuminate.effcomm.com/v1/users?page=3&limit=3&order_by=name&order=asc",
		},
	},
	{
		name:  "Successful links creation - last page",
		url:   "api.illuminate.effcomm.com/v1/users?page=4&limit=3&order_by=name&order=asc",
		count: 2,
		links: &pagination.Links{
			Next:     "",
			Previous: "api.illuminate.effcomm.com/v1/users?limit=3&order=asc&order_by=name&page=3",
			Self:     "api.illuminate.effcomm.com/v1/users?page=4&limit=3&order_by=name&order=asc",
		},
	},
}
